...
export const db = factory({
  ...
  device: {
    ...
    serialNumber: primaryKey(faker.random.words),
...
db.device.create({ name: 'device2', serialNumber: '0000000002', status: 'off', createTime: new Date() })
...
db.device.create({ name: 'device5', serialNumber: '0000000005', status: 'off', createTime: new Date() })
db.device.create({ name: 'device6', serialNumber: '0000000006', status: 'on', createTime: new Date() })
db.device.create({ name: 'device7', serialNumber: '0000000007', status: 'processing', createTime: new Date() })
...
db.device.create({ name: 'device10', serialNumber: '0000000010', status: 'error', createTime: new Date() })
